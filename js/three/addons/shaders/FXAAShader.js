...
const FXAAShader = {
	...
	fragmentShader: /* glsl */`
		...
		void main() {
			...
			vec4 rgbA = (1.0 / 2.0) * ( texture( tDiffuse,  gl_FragCoord.xy  * resolution + dir * (1.0 / 3.0 - 0.5) ) + texture( tDiffuse,  gl_FragCoord.xy  * resolution + dir * (2.0 / 3.0 - 0.5) ) );
			vec4 rgbB = rgbA * (1.0 / 2.0) + (1.0 / 4.0) * ( texture( tDiffuse,  gl_FragCoord.xy  * resolution + dir * (0.0 / 3.0 - 0.5) ) + texture( tDiffuse,  gl_FragCoord.xy  * resolution + dir * (3.0 / 3.0 - 0.5) ) );
